...
**Output:** AGENTS.md + ASSETS.md + PLAN.md + README.md
...
should cover three areas to match the README: **implementation, testing,
...
Label each task with its phase prefix so the README can reference them:
`[A-01]`, `[B-03]`, `[D-02]`, etc.

**Update mode:** Append as **《Design v{number} Increment》** section.

## 6e. Generate README.md — Execution Roadmap

Generate `README.md` — the single handoff document that tells the user
...
section to README.md rather than replacing it. Reference unchanged phases
with "No changes from v{number}."

## After Completion

Use AskUserQuestion to confirm the plan and README:

```json
{ "header": "Confirm", "question": "PLAN.md, README.md and ASSETS.md are ready. All Phase 1 context files generated.", "options": [
...
todo list: mark "Generate AGENTS.md + PLAN.md + README.md" complete with a
